...
print("Probability= [0.7,0.1,0.2],starting position=0, expected distance:",np.mean(output1))
print("Probability= [0.1,0.2,0.7],starting position=0, expected distance:",np.mean(output2))
